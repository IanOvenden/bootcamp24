...
test.describe('E2E test', () => {
  ...
  test('should login, create case and run the RichText tests', async ({ page }) => {
    ...
    /** Required tests */
    const requiredRichTextContainer = page.locator(
      'div[data-test-id="98a97d9fe6d092900021587f62ab8637"]'
    );
    ...
    const notRequiredRichTextContainer = page.locator(
      'div[data-test-id="913fcb2ea3513d1f0dd357aa1766757f"]'
    );
    ...
    const alwaysDisabledRichTextContainer = page.locator(
      'div[data-test-id="f8a6fa176e492f0b2c3a2ecce916a1cc"]'
    );
    ...
    const alwaysDisabledRichTextBox =
      alwaysDisabledRichTextContainer.locator('div[role="application"]');
    ...
    const conditionallyDisabledRichTextContainer = page.locator(
      'div[data-test-id="a1f1fed886e4277998358560643d5b80"]'
    );
    const conditionallyDisabledRichTextLabel =
      conditionallyDisabledRichTextContainer.locator('label');
    expect(await conditionallyDisabledRichTextLabel.innerText()).toEqual(
      'RichText Disabled Condition'
    );
    const conditionallyDisabledRichTextBox =
      conditionallyDisabledRichTextContainer.locator('div[role="application"]');
    ...
    const neverDisabledRichTextContainer = page.locator(
      'div[data-test-id="0706d1c3117909bba5dc3b11282c84c1"]'
    );
    ...
    const neverDisabledRichTextBox =
      neverDisabledRichTextContainer.locator('div[role="application"]');
    ...
    /** Update tests */
    const readOnlyRichTextContainer = page.locator(
      'div[data-test-id="2698790fe2608356645f7f37e47d4017"]'
    );
    ...
    const readOnlyRTEDiv = readOnlyRichTextContainer.locator(
      'div[class="readonly-richtext-editor"]'
    );
    expect(readOnlyRTEDiv).toBeVisible();

    const editableRichTextContainer = page.locator(
      'div[data-test-id="c5f3892e688f607040637162ef2d61e2"]'
    );
    ...
    /** Visibility tests */
    await expect(
      page.locator('div[data-test-id="4094af7d82d8e88494423b891852cfb3"]')
    ).toBeVisible();

    const neverVisibleRichText = await page.locator(
      'div[data-test-id="be4eec910ae6fd21f9ff706a3d64dc58"]'
    );
    await expect(neverVisibleRichText).not.toBeVisible();

    const conditionallyVisibleRichText = await page.locator(
      'div[data-test-id="c50c684046dd7f7ca04fd9e35ed0ec92"]'
    );
